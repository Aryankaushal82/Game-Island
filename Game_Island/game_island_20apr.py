...
def in_to_forgot(event):
    ...
    forgot_frame.place(relx = 0.25,rely=0.27,bordermode = "outside")
...
login_back = customtkinter.CTkFrame(master=sign,fg_color="white",corner_radius=8,bg_color="grey",width = 500,height=500)
# login_back = customtkinter.CTkFrame(master= sign, height=800)
login_back.place(relx = 0.25,rely=0.15,bordermode = "outside")
...
login_back_2 = customtkinter.CTkFrame(master=login_frame,fg_color="white",corner_radius=8,bg_color="grey",width = 500,height = 350)
login_back_2.place(relx = 0.25,rely=0.27,bordermode = "outside")
...
login_back_1 = customtkinter.CTkFrame(master=password_frame,fg_color="white",corner_radius=8,bg_color="grey",width = 500,height = 300)
login_back_1.place(relx = 0.25,rely=0.3,bordermode = "outside")
